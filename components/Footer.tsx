  ...
  return (
    <footer className="relative bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
          ...
          <div className="flex justify-center space-x-6">
            {socialLinks.map((link, index) => (
              <a
                ...
                className="text-gray-600 hover:text-blue-500 dark:text-gray-300 dark:hover:text-blue-400 transition-colors duration-300 hover:scale-110 active:scale-95"
                title={link.label}
              >
                {link.icon}
              </a>
      ...
      {isVisible && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 p-3 rounded-full bg-white dark:bg-gray-800 shadow-lg hover:shadow-xl transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 hover:scale-110 active:scale-95"
